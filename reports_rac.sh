...
#---
#--- POUR INFO : on affiche les bases SE avec l'option RAC 
#---
...
export WHERE="r.nodes_count > 1 and locate('Enterprise', banner)=0"
...
if [ "$RESULT" != "" ]; then
        echo $YELLOW
        echo "#--------------------------------------------------------------------------------#"
        echo "# Option RAC en Standard Edition : l'option est gratuite."
        echo "#--------------------------------------------------------------------------------#"
        echo $NOCOLOR
...
#---
#--- Enterprise Edition : on affiche les bases EE avec l'option RAC et on fait le calcul des processeurs
#---

#--- les variables SELECT, FROM et ORDERBY ne changent pas, seule WHERE est modifiée :
export WHERE="r.nodes_count > 1 and locate('Enterprise', banner)>0"
...
if [ "$RESULT" != "" ]; then
        echo $YELLOW
        echo "#--------------------------------------------------------------------------------#"
        echo "# Option RAC en Enterprise Edition"
        echo "#--------------------------------------------------------------------------------#"
        echo $NOCOLOR
